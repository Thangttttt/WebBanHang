...
<link href="/us/css/range.css" rel="stylesheet">
</head>
<body>
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<div class="wrapper">
														<div class="price-input">
															<div class="field">
																<span>Min</span> <input name="min" type="number" class="input-min"
																	value="2500">
															</div>
															<div class="separator">-</div>
															<div class="field">
																<span>Max</span> <input name="max" type="number" class="input-max"
																	value="7500">
															</div>
														...
														<div class="range-input">
															<input type="range" class="range-min" min="0" max="10000"
																...
																class="range-max" min="0" max="10000" value="7500"
																step="100">
														</div>
														
														<button class="qt">Search</button>
													</div>
													</form>
												</div>
											</div>
								...
								<div class="product-item">
									...
									<div class="product-image">
										...
										<div class="product-action">
											<a href="/cart/add/${item.id}"><i class="fa fa-cart-plus"></i></a> 
											<!-- <a href="#"><i
												class="fa fa-heart"></i></a>  -->
												<a href="/detail/add/${item.id}"><i
												class="fa fa-search"></i></a>
										</div>
									</div>
									<div class="product-price">
										<h3>
											<span>$</span>${item.price}</h3>
						...
						<nav aria-label="Page navigation example">
							<ul class="pagination justify-content-center">
								<li class="page-item"><a class="page-link"
									href="/estore/product?p=0">First</a></li>
								<li class="page-item"><a class="page-link"
									href="/estore/product?p=${items.number-1}"><<</a></li>
								<li class="page-item"><a class="page-link"
									href="/estore/product?p=${items.number+1}">>></a></li>
								<li class="page-item"><a class="page-link"
									href="/estore/product?p=${items.totalPages-1}">Last</a></li>
							</ul>
						</nav>
					</div>
					<!-- Pagination Start -->
					...
					<div class="sidebar-widget widget-slider">
						<div class="sidebar-slider normal-slider">
							<div class="product-item">
								...
								<div class="product-image">
									<a href="product-detail.html"> <img
										src="/us/img/product-10.jpg" alt="Product Image">
									</a>
									<div class="product-action">
							...
							<div class="product-item">
								...
								<div class="product-image">
									<a href="product-detail.html"> <img
										src="/us/img/product-9.jpg" alt="Product Image">
									</a>
									<div class="product-action">
										<a href="#"><i class="fa fa-cart-plus"></i></a> <a href="#"><i
											class="fa fa-heart"></i></a> <a href="#"><i
							...
							<div class="product-item">
								...
								<div class="product-image">
									<a href="product-detail.html"> <img
										src="/us/img/product-8.jpg" alt="Product Image">
									</a>
									<div class="product-action">
										<a href="#"><i class="fa fa-cart-plus"></i></a> <a href="#"><i
											class="fa fa-heart"></i></a> <a href="#"><i
	...
	<script src="/us/js/script.js"></script>
</body>
</html>