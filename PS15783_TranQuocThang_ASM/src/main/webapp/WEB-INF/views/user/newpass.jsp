		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-6 m-auto">
					<form action="/estore/newpass" method="post">
					${message}
						<div class="login-form">
							<div class="row">
								<div class="col-md-6">
									<label>New Pass</label> <input class="form-control"
										name="newpass" type="text" placeholder="Nhập Pass mới ">
								</div>
								<div class="col-md-6">
									<label>Password</label> <input class="form-control"
										name="newpasswordcon" type="text" placeholder="Nhập lại Password mới">
								</div>
								<div class="col-md-12">
