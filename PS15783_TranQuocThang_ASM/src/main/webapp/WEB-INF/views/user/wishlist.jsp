                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">CÀI ĐẶT</a>
                        ...
                        <div class="navbar-nav ml-auto">
                            <a href="" class="nav-item nav-link">TÀI KHOẢN</a>
                        </div>
                    </div>
                </nav>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <div class="contact-info">
                                <p><i class="fa fa-map-marker"></i>365/12 TÔ KÝ Q.12 TP.HCM </p>
                                <p><i class="fa fa-envelope"></i> estoresupport@.com</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-widget">
                            ...
                            <ul>
                                <li><a href="#">Chính Sách Pyament</a></li>
